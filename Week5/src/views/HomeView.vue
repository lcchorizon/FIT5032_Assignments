          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                >
                <div class="form-text">This field uses one-way data binding.</div>
              </div>
            </div>
          </div>
...
const validateConfirmPassword = (showError) => {
  if (formData.value.password !== formData.value.confirmPassword) {
    if (showError) errors.value.confirmPassword = 'Passwords do not match.'
    return false
  }
...
const submitForm = () => {
  ...
  const confirmPasswordIsValid = validateConfirmPassword(true)
